...
cv::Mat distortion_1;
cv::Mat extrinsic_matrix_1_tmp;
cv::Mat camera_matrix_1_tmp;
cv::Mat new_camera_matrix_1_tmp;
cv::Mat distortion_1_tmp;
...
int main(int argc, char *argv[])
{
    ...
    cv::Mat img(cv::Size(640,100),CV_8UC3,cv::Scalar(0,0,0));
    cv::namedWindow("control panel",cv::WINDOW_AUTOSIZE);

    double offset_x = offset_vector[0];
    double offset_y = offset_vector[1];
    double offset_z = offset_vector[2];
    double offset_x_angle = offset_vector[3];
    double offset_y_angle = offset_vector[4];
    double offset_z_angle = offset_vector[5];
    // double tmp = offset_x * 10 + 100;
    // int offset_x_ref = (int)tmp;
    // tmp = offset_y * 10 + 100;
    // int offset_y_ref = (int)tmp;
    // tmp = offset_z * 10 + 100;
    // int offset_z_ref = (int)tmp;

    int tmp = 100;
    int offset_x_ref = (int)tmp;
    int offset_y_ref = (int)tmp;
    int offset_z_ref = (int)tmp;
    int offset_x_angle_ref = (int)tmp;
    tmp = 100;
    int offset_y_angle_ref = (int)tmp;
    tmp = 100;
    int offset_z_angle_ref = (int)tmp;
    cv::createTrackbar("x","control panel",&offset_x_ref,(int)(200));
    cv::createTrackbar("y","control panel",&offset_y_ref,(int)(200));
    cv::createTrackbar("z","control panel",&offset_z_ref,(int)(200));
    cv::createTrackbar("xx","control panel",&offset_x_angle_ref,(int)(200));
    cv::createTrackbar("yy","control panel",&offset_y_angle_ref,(int)(200));
    cv::createTrackbar("zz","control panel",&offset_z_angle_ref,(int)(200));
    ...
    while (ros::ok())
    {
      ...
      double offset_x = ((double)offset_x_ref-100)/10 + offset_vector[0];
      double offset_y = ((double)offset_y_ref-100)/10 + offset_vector[1];
      double offset_z = ((double)offset_z_ref-100)/10 + offset_vector[2];
      double offset_angle_x = ((double)offset_x_angle_ref-100)/10 + offset_vector[3];
      double offset_angle_y = ((double)offset_y_angle_ref-100)/10 + offset_vector[4];
      double offset_angle_z = ((double)offset_z_angle_ref-100)/10 + offset_vector[5];
      std::cout << "x=" << offset_x << " y=" << offset_y << " z=" << offset_z << " xx=" << offset_angle_x << " yy=" << offset_angle_y << " zz=" << offset_angle_z << std::endl;
      ...
      //            0.0, 0.0, 1.0);
      extrinsic_matrix_1_tmp = (cv::Mat_<double>(4, 4) << extrinsic_matrix_1_vector[0], extrinsic_matrix_1_vector[1], extrinsic_matrix_1_vector[2], extrinsic_matrix_1_vector[3], extrinsic_matrix_1_vector[4], extrinsic_matrix_1_vector[5], extrinsic_matrix_1_vector[6], extrinsic_matrix_1_vector[7], extrinsic_matrix_1_vector[8], extrinsic_matrix_1_vector[9], extrinsic_matrix_1_vector[10], extrinsic_matrix_1_vector[11], extrinsic_matrix_1_vector[12], extrinsic_matrix_1_vector[13], extrinsic_matrix_1_vector[14], extrinsic_matrix_1_vector[15]);
      camera_matrix_1_tmp = (cv::Mat_<double>(3, 3) << intrinsics_vector[0], intrinsics_vector[1], intrinsics_vector[2], intrinsics_vector[3], intrinsics_vector[4], intrinsics_vector[5], intrinsics_vector[6], intrinsics_vector[7], intrinsics_vector[8]);
      new_camera_matrix_1_tmp = (cv::Mat_<double>(3, 3) << new_camera_matrix_1_vector[0], new_camera_matrix_1_vector[1], new_camera_matrix_1_vector[2], new_camera_matrix_1_vector[3], new_camera_matrix_1_vector[4], new_camera_matrix_1_vector[5], new_camera_matrix_1_vector[6], new_camera_matrix_1_vector[7], new_camera_matrix_1_vector[8]);
      distortion_1_tmp = (cv::Mat_<double>(1, distortionCoeffs_vector.size()) << distortionCoeffs_vector[0], distortionCoeffs_vector[1], distortionCoeffs_vector[2], distortionCoeffs_vector[3], distortionCoeffs_vector[4]);
      camera1.rotation = extrinsic_matrix_1_tmp(cv::Rect(0, 0, 3, 3));
      camera1.translation = extrinsic_matrix_1_tmp(cv::Rect(3, 0, 1, 3));
      camera1.offset(offset_x, offset_y, offset_z, offset_angle_x * PI / 180, offset_angle_y * PI / 180, offset_angle_z * PI / 180);
      // camera1.rotation = camera1.rotation * rot_x.t() * rot_y.t() * rot_z.t();
      // std::cout << camera1.rotation << std::endl;
      // camera1.translation = camera1.translation - camera1.rotation * vector;
