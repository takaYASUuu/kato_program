...
int main(int argc, char *argv[])
{
    ...
    while (ros::ok()){
      ...
      double offset_x = ((double)offset_x_ref-100)/1 + offset_vector[0];
      double offset_y = ((double)offset_y_ref-100)/1 + offset_vector[1];
      double offset_z = ((double)offset_z_ref-100)/1 + offset_vector[2];
      double offset_angle_x = ((double)offset_x_angle_ref-100)/1 + offset_vector[3];
      double offset_angle_y = ((double)offset_y_angle_ref-100)/1 + offset_vector[4];
      double offset_angle_z = ((double)offset_z_angle_ref-100)/1 + offset_vector[5];
